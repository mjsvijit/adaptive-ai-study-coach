...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full z-99999 dark:bg-gray-900 bg-brand-900 h-[72px] shadow-sm">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-5">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-white bg-brand-500 rounded z-99999 flex dark:text-gray-400"
